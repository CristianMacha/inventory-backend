...
describe('CreateUserHandler', () => {
  ...
  beforeEach(() => {
    ...
    handler = new CreateUserHandler(userRepositoryMock, uuidGeneratorMock, hasherMock);
  })
  ...
  it('should call save if the user does not exist', async () => {
    ...
    const command = new CreateUserCommand('cristian', 'cristian@gmail.com', rawPassword);
  ...
  it('It should throw UserAlreadyExistsException if the user already exists.', async () => {
    ...
    const command = new CreateUserCommand('cristian', 'cristian@gmail.com', 'cristianmx10');
