...
@CommandHandler(ApproveJobCommand)
export class ApproveJobHandler implements ICommandHandler<ApproveJobCommand> {
  constructor(
  ...
  async execute(command: ApproveJobCommand): Promise<void> {
