...
export class AddQtyAproved1778602837318 implements MigrationInterface {
  name = 'AddQtyAproved1778602837318';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE \`workshop_requests\` ADD \`approvedQuantity\` decimal(12,3) NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`workshop_requests\` DROP COLUMN \`approvedQuantity\``,
    );
  }
}
